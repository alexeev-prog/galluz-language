...
hidden if the `galluzlang_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `galluzlang_DEVELOPER_MODE` to the configure
...
Runs the executable target `galluzlang_exe`.
