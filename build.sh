...
print_intro() {
    echo -e "${BLUE}"
    echo -e "${BLUE}███    ██  ██████  ${NC}   ${GREEN}galluz language${NC}"
    echo -e "${BLUE}████   ██ ██       ${NC}   ${GREEN}Maintained by alexeev-prog${NC}"
    echo -e "${BLUE}██ ██  ██ ██   ███ ${NC}   ${CYAN}\033[4mhttps://github.com/alexeev-prog/galluz-language${NC}\033[0m"
    echo -e "${BLUE}██  ██ ██ ██    ██ ${NC}   ${CYAN}\033[4mhttps://alexeev-prog.github.io/galluz-language${NC}\033[0m"
    echo -e "${BLUE}██   ████  ██████  ${NC}   ${YELLOW}Copyright 2025 (C) alexeev-prog${NC}"
    echo -e "${NC}"
}

print_intro
print_title "galluz.lang Build System"
...
configure_project() {
    ...
    # Common flags
    cmake_flags+=("-Dgalluzlang_DEVELOPER_MODE=$DEVELOPER_MODE")
